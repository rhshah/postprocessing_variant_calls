...
ARG POSTPROCESSING_VARIANT_CALLS_VERSION="0.0.1"
ARG POSTPROCESSING_VARIANT_CALLS_BRANCH="develop"
ARG VCS_REF
...
RUN cd /opt \ 
    && git clone -b ${POSTPROCESSING_VARIANT_CALLS_BRANCH} https://github.com/msk-access/postprocessing_variant_calls.git \ 
